...
//    println(jogoResidentVillage)
    ...
    gamerCaroline.plano = PlanoAssinatura("PRATA", 9.90, 3, 0.15)
    ...
    val serealizacao = gson.toJson(gamerCamila.jogosRecomendados)
    println(serealizacao)

    val arquivo = File("jogosRecomendados-${gamerCamila.nome}.json")
    arquivo.writeText(serealizacao)
